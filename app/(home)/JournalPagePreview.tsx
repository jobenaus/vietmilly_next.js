...
export default function JournalPagePreview({
  ...
  return (
    <div className="mt-10 first:mt-6 pb-8 sm:pb-16 sm:mt-12 sm:first:mt-8 flex flex-col items-center border-b-2 last:border-b-0 border-black">
      <h1 className="text-5xl  font-bold mb-10">{previewTitle}</h1>
